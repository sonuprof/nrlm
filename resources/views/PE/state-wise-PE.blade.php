            ...
            <div class="card shadow-none">
              <div class="card-header newHead">
                <h3 class="card-title" style="font-weight: bold;">
                   State Wise PE Details
                </h3>
              </div>

              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped d-block" style="overflow-x: ,text">
                  <thead>
                    <tr>
                      <th>Sr No</th>
                      <th>State</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{ $i++ }}</td>
                      <td><a href="#" >{{$pes->state }}</a></td>
                      <td><a href="{{route('PE-districts', ['district' => $pes->district]) }}" >{{$pes->district }}</a></td>
                      <td>{{ $pes->promotin_g_agency }}</td>
                      <td>{{ $pes->fpo }}</td>
                      <td>{{ $pes->regs_date }}</td>
                      <td>{{ $pes->commodity }}</td>
                      <td>{{ $pes->members }}</td>
