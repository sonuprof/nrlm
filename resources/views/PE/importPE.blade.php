        ...
        <div class="container-fluid">
            <div class="card card-default mt-4">
                <div class="card-header newHead">
                    <h3 class="card-title text-bold">Import PE</h3>
                </div>
                @if(session()->has('status'))
                    ...
                    @endif
                <form action="{{route('PEimport')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2 text-muted">Choose File</h6>
                        <div class="row">
                            <input type="file" name="pe_excel" class="form-control">
                        </div>
                    </div>
