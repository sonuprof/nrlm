        ...
        <div class="container-fluid">
            <div class="card card-default mt-4">
                <div class="card-header newHead">
                    <h3 class="card-title text-bold">Import FPO</h3>
                </div>
                @if(session()->has('status'))
                    ...
                    @endif
                <form action="{{route('FPOimport')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2 text-muted">Choose File</h6>
                        <div class="row">
                            <input type="file" name="fpo_excel" class="form-control">
                        </div>
                    </div>
